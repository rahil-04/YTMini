...
//Primary API KEY: AIzaSyA4LM7t2WFcwFSz4dRoTpERZz8UwzRlB1w
//Secondary API KEY: AIzaSyBuct1MP42aAepnpTyjKlgBlZtBl5se5bg

const API_KEY = "AIzaSyBuct1MP42aAepnpTyjKlgBlZtBl5se5bg";
...
export const YT_SEARCH_RES_API = `https://youtube.googleapis.com/youtube/v3/search?part=snippet&maxResults=25&q=[Search]&key=${API_KEY}`